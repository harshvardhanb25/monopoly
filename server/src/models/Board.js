...
class Board {
  ...
  initSquares() {
    ...
    const squares = []
    squares.push(new GoSquare())
    squares.push(new PropertySquare(this.properties[0]))
    squares.push(new CommunityChestSquare())
    squares.push(new PropertySquare(this.properties[1]))
    squares.push(new TaxSquare(200))
    squares.push(new RailroadSquare(this.properties[22]))
    squares.push(new PropertySquare(this.properties[2]))
    squares.push(new ChanceSquare())
    squares.push(new PropertySquare(this.properties[3]))
    squares.push(new PropertySquare(this.properties[4]))
    squares.push(new JailSquare())
    squares.push(new PropertySquare(this.properties[5]))
    squares.push(new UtilitySquare(this.properties[26]))
    squares.push(new PropertySquare(this.properties[6]))
    squares.push(new PropertySquare(this.properties[7]))
    squares.push(new RailroadSquare(this.properties[23]))
    squares.push(new PropertySquare(this.properties[8]))
    squares.push(new CommunityChestSquare())
    squares.push(new PropertySquare(this.properties[9]))
    squares.push(new PropertySquare(this.properties[10]))
    squares.push(new FreeParkingSquare())
    squares.push(new PropertySquare(this.properties[11]))
    squares.push(new ChanceSquare())
    squares.push(new PropertySquare(this.properties[12]))
    squares.push(new PropertySquare(this.properties[13]))
    squares.push(new RailroadSquare(this.properties[24]))
    squares.push(new PropertySquare(this.properties[14]))
    squares.push(new PropertySquare(this.properties[15]))
    squares.push(new UtilitySquare(this.properties[27]))
    squares.push(new PropertySquare(this.properties[16]))
    squares.push(new GoToJailSquare())
    squares.push(new PropertySquare(this.properties[17]))
    squares.push(new PropertySquare(this.properties[18]))
    squares.push(new CommunityChestSquare())
    squares.push(new PropertySquare(this.properties[19]))
    squares.push(new RailroadSquare(this.properties[25]))
    squares.push(new ChanceSquare())
    squares.push(new PropertySquare(this.properties[20]))
    squares.push(new TaxSquare(100))
    squares.push(new PropertySquare(this.properties[21]))
    return squares
  }
  ...
  movePlayer(roll) {
    ...
    if (newPosition >= this.squares.length) {
      this.currentPlayer.setBalance(
        this.currentPlayer.getBalance() + 200
      )
    }
