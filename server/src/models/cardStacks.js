...
chanceCardDeck.push(new Card("Advance to Boardwalk", advanceToBoardwalkAction))
...
communityChestCardDeck.push(new Card("Doctor's fee. Pay $50", doctorsFeeAction))
...
communityChestCardDeck.push(
    new Card("Life insurance matures. Collect $100", lifeInsuranceMaturesAction)
)
...
const beautyContestAction = (player, otherplayers) => {
...
export { chanceCardDeck, communityChestCardDeck }
